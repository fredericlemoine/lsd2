...
bool reroot_rootedtree(double& br,double& br2, int r,int s1, int s2,Pr* pr,Node** nodes,Node** &nodes_new);
...
bool reroot_rootedtree(double& br,double& br2,int r,int s1, int s2,Pr* pr,Node** nodes,Node** &nodes_new,int* & P_ref,int* & tab);
